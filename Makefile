...
SRCDIR = ./
FILES = diskquota.c enforcement.c quotamodel.c gp_activetable.c diskquota_utility.c diskquota_unit_test.c
OBJS = diskquota.o enforcement.o quotamodel.o gp_activetable.o diskquota_utility.o diskquota_unit_test.o
