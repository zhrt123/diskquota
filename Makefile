...
SRCDIR = ./
FILES = diskquota.c enforcement.c quotamodel.c gp_activetable.c diskquota_utility.c gp_utils.c
OBJS = diskquota.o enforcement.o quotamodel.o gp_activetable.o diskquota_utility.o gp_utils.o
